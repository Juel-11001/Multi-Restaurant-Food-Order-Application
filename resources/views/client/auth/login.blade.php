                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="mb-4 mb-md-5 text-center">
                            <a href="index.html" class="d-block auth-logo">
                                <img src="{{asset('backend/assets/images/logo-sm.svg')}}" alt="" height="28"> <span class="logo-txt">Client</span>
                            </a>
                        </div>
                        <div class="auth-content my-auto">
                            ...
                            @endif
                            <form class="mt-4 pt-2" action="{{ route('client.login') }}" method="post">
                                @csrf
                                <div class="mb-3">
