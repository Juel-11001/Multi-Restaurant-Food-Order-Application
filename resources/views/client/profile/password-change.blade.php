        ...
        <div class="container-fluid">
                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{ !empty($profile->image) ? url('uploads/client_profile/' . $profile->image) : url('uploads/no_image.jpg') }}"
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <form  method="POST" action="{{ route('client.profile.password-update') }}" class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0">
                                @csrf
                                <div class="col-sm-4">
