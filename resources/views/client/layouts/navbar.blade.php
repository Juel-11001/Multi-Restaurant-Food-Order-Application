<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            @php
                $profile_data = Auth::guard('client')->id();
                $profile = App\Models\Client::find($profile_data);

            @endphp
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{(!empty($profile->image))?url('uploads/client_profile/'.$profile->image):url('uploads/no_image.jpg')}}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ $profile->name }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('client.profile.password-change') }}"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Change Password</a>
