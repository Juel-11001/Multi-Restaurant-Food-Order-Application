                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{(!empty($admin->photo)) ? url('uploads/admin_profile/'.$admin->photo) : url('uploads/no_image.jpg')}}"
                                        ...
                                        <div class="flex-grow-1">
                                            <div>
                                                ...
                                                <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                    <div>
                                                        <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>{{$admin->phone}}
                                                    </div>
                                                    <div>
                                                        <i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>{{$admin->address}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="name" type="text"
                                                       value="{{ $admin->name }}" id="example-text-input">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="phone" type="tel"
                                                       value="{{ $admin->phone }}" id="example-tel-input">
                                            </div>
                                            <div class="mt-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            <div class="flex-shrink-0">
                                                <div class="avatar-xl me-3">
                                                    <img src="{{(!empty($admin->photo)) ? asset('uploads/admin_profile/'.$admin->photo):asset('uploads/no_image.jpg')}}"
