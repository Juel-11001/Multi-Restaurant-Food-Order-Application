@extends('admin.auth.layouts.master-auth')
@section('content')
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4" action="{{ route('admin.forgot-password-submit') }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Remember It ? <a href="{{ url('admin/login') }}"
                                            class="text-primary fw-semibold"> Sign
                                            In </a></p>
                                </div>
                            </div>
