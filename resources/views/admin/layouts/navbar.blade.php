<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            @php
                $profile_data = Auth::guard('admin')->id();
                $profile = App\Models\Admin::find($profile_data);

            @endphp
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{(!empty($profile->photo))?url('uploads/admin_profile/'.$profile->photo):url('uploads/no_image.jpg')}}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.profile.password-change') }}"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Change Password</a>
